...
export default function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="py-16 sm:py-24 px-6 bg-cream-50 dark:bg-slate-900 relative overflow-hidden"
    >
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="text-center mb-10 sm:mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold text-charcoal-900 dark:text-slate-100 mb-4 inline-block relative group">
            Let's Work Together
          ...
          <p className="text-charcoal-600 dark:text-slate-400 mt-4 max-w-2xl mx-auto text-base sm:text-lg">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="space-y-6 sm:space-y-8">
            <div className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm p-6 sm:p-8 rounded-2xl border border-sage-100 dark:border-slate-700 shadow-sm h-full">
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-charcoal-800 dark:text-slate-200 font-medium group-hover:text-sage-600 dark:group-hover:text-gold-400 transition-colors break-all">
          ...
          <div className="relative">
            <div
              className={`transition-all duration-500 bg-white dark:bg-slate-800 p-6 sm:p-10 rounded-2xl shadow-xl border border-sage-100 dark:border-slate-700 relative overflow-hidden h-full ${isSuccess ? "scale-[1.02] shadow-2xl" : ""}`}
            >
              {/* SUCCESS OVERLAY */}
              {isSuccess && (
              ...
              >
                ...
                <button
                  type="submit"
                  disabled={isLoading || isRateLimited}
                  className="w-full mt-6 py-4 px-6 text-base sm:text-lg font-medium rounded-xl transition-all duration-300 bg-sage-600 hover:bg-sage-700 dark:bg-amber-600 dark:hover:bg-amber-700 text-white hover:shadow-lg hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0 disabled:hover:shadow-none focus:outline-none focus:ring-2 focus:ring-sage-500 dark:focus:ring-amber-500 focus:ring-offset-2 flex items-center justify-center space-x-2"
                >
                  {isLoading ? (
                    <>
